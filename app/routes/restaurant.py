...
async def create_restaurant(
    ...
    db_restaurant = crud_restaurants.create_restaurant(
        db, restaurant, manager_id=manager.manager_id
    )
...
async def get_restaurants_by_manager(
    ...
    restaurants = crud_restaurants.get_restaurants_by_manager(
        db, manager_id=manager.manager_id
    )
    return restaurants
...
async def get_restaurant_details(
    ...
    restaurant = crud_restaurants.get_restaurant_by_id_and_manager(
        db, restaurant_id, user["user_id"]
    )
    if not restaurant:
        raise HTTPException(
...
async def update_restaurant_details(
    ...
    updated_restaurant = crud_restaurants.update_restaurant(
